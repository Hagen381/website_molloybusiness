...
// Kachelbeschriftung: dieselbe Schriftgröße wie die goldene H2, aber weiß auf
// dem Foto. Im Original ist das ein <h2> in der Kachel; hier <h4>, damit die
// Überschriftenreihenfolge unter der H3 des Abschnitts gültig bleibt.
const KACHEL_TITEL =
  "font-heading font-normal tracking-[1.4px] text-white text-[24px] leading-[28px] md:text-[32px] md:leading-[36px]";

// ---------------------------------------------------------------------------
// Die vier Angebote. Titel und Route kommen aus site-config; hier stehen nur
// die im Original zweizeilige Kachelbeschriftung und das Kachelbild.
// Die Bildzuordnung stammt aus den alt-Texten der jeweiligen Angebotsseite
// (siehe docs/original/bild-inventar.md) — im archivierten HTML dieser Seite
// standen die Kachelbilder nicht, sie kamen aus dem externen Elementor-CSS.
// ---------------------------------------------------------------------------
const kacheln = [
  {
...
export default function AngebotePage() {
  return (
    <>
      ...
      {/* ------------------------------------------------------------------
          1) HERO — Hintergrund #D9D9D9, 80px oben / 50px unten.
          50/50 wie im Original (elementor-col-50), Text links, Bild rechts.
          ------------------------------------------------------------------ */}
      ...
      {/* ------------------------------------------------------------------
          2) "Hast du…" — Hintergrund #FFFFFF, 100px/100px.
          Im Original zwei Textspalten 50/50: links der Überschriftenblock mit
          Trennlinie, rechts Fließtext und Aufzählung.
          ------------------------------------------------------------------ */}
      ...
      {/* ------------------------------------------------------------------
          3) "Stell dir vor…" — Hintergrund #D9D9D9, 100px/100px.
      ...
      {/* ------------------------------------------------------------------
          4) Zitat-Trenner — der eine dunkle Abschnitt (#595959), 80px/80px.
          ------------------------------------------------------------------ */}
      <section className="bg-footer">
        <div className="container-page py-[80px] text-center">
          <p
            aria-hidden="true"
          ...
          <p className={`${H2_DARK} font-heading mt-4`}>
      ...
      {/* ------------------------------------------------------------------
          5) Die Angebots-Kacheln — Hintergrund #FFFFFF, 100px/100px.
          Im Original drei Abschnitte mit je zwei Kacheln (elementor-col-50);
          hier ein 2-spaltiges Raster, das bei vier Kacheln dieselben zwei
          Reihen ergibt.
          ------------------------------------------------------------------ */}
      <section id="angebote" className="bg-surface scroll-mt-24">
        <div className="container-page py-[100px]">
          ...
          <div className="mt-12 grid gap-10 md:grid-cols-2 md:gap-x-[20px]">
            {angebote.map((angebot) => (
              <Link
                key={angebot.href}
                href={angebot.href}
                aria-label={angebot.title}
                className="group relative block aspect-[11/8] overflow-hidden rounded-[15px]"
              >
                <ExportedImage
                  src={angebot.bild}
                  alt=""
                  ...
                  basePath={basePath}
                />
                {/* Im Original liegt über dem Kachelbild ein Elementor-Overlay;
                    Farbe und Deckkraft standen im nicht archivierten CSS. */}
      ...
      {/* ------------------------------------------------------------------
          6) Kundenstimmen — Hintergrund #D9D9D9, 100px/100px.
          Im Original ein Swiper-Karussell, das zweimal im Markup steht
          (Desktop- und Mobilfassung). Hier einmal als responsives Raster.
          ------------------------------------------------------------------ */}
      <section className="bg-gray-light">
        <div className="container-page py-[100px]">
          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:gap-x-[20px]">
            {kundenstimmen.map((stimme) => (
              <figure key={stimme.name} className="flex gap-5">
                <div className="relative h-[80px] w-[80px] shrink-0 overflow-hidden rounded-full bg-surface">
                  <ExportedImage
                    src={stimme.foto}
                    alt={stimme.alt}
                    fill
                    className={stimme.contain ? "object-contain p-2" : "object-cover"}
                    sizes="80px"
                    basePath={basePath}
                ...
                <div>
                  ...
                  <figcaption className={`${BODY} mt-3`}>
      ...
      {/* ------------------------------------------------------------------
          7) Abschluss — Hintergrund #FFFFFF, 100px/100px.
          Text links, Bild rechts (50/50 wie im Original).
          ------------------------------------------------------------------ */}
      <section className="bg-surface">
        <div className="container-page py-[100px]">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-x-0">
            <div className={`self-center ${COL}`}>
              <h2 className={H2_STANDARD}>
              ...
              {/* Im Original ein mailto — bei einer Terminvereinbarung ist der
                  Calendly-Link das richtige Ziel. */}
              <div className="mt-8">
                <a
