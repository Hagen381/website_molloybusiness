...
const toc = [
  { id: "ohne-website-will-ich-mein-business-nicht-starten", label: "Ohne Website will ich mein Business nicht starten" },
  { id: "ich-begann-mit-einem-wordpress-youtube-tutorial", label: "Ich begann mit einem WordPress-Youtube-Tutorial" },
  { id: "was-ist-denn-ein-onepager", label: "Was ist denn ein Onepager?" },
  { id: "richtige-gruende-fuer-eine-website", label: "„Richtige“ Gründe für eine Website" },
  { id: "deine-website-ist-dein-zuhause", label: "Deine Website ist dein Zuhause" },
  { id: "zum-schluss-noch-dieses-seo", label: "Zum Schluss noch dieses SEO" },
  { id: "jetzt-aber-wirklich-das-schlusswort", label: "Jetzt aber wirklich das Schlusswort" },
  ...
  return (
    <>
      ...
      <section className="article-column py-[30px]">
        <h2 id="ohne-website-will-ich-mein-business-nicht-starten" className="article-h2">
      ...
      {/* WordPress-Tutorial */}
      <section className="article-column py-[30px]">
        <h2 id="ich-begann-mit-einem-wordpress-youtube-tutorial" className="article-h2">
      ...
      {/* Onepager */}
      <section className="article-column py-[30px]">
        <h2 id="was-ist-denn-ein-onepager" className="article-h2">
      ...
      {/* Gründe */}
      <section className="article-column py-[30px]">
        <h2 id="richtige-gruende-fuer-eine-website" className="article-h2">
      ...
      {/* Zuhause */}
      <section className="article-column py-[30px]">
        <h2 id="deine-website-ist-dein-zuhause" className="article-h2">
      ...
      {/* SEO */}
      <section className="article-column py-[30px]">
        <h2 id="zum-schluss-noch-dieses-seo" className="article-h2">
      ...
      {/* Schlusswort + CTA */}
      <section className="article-column py-[30px]">
        <h2 id="jetzt-aber-wirklich-das-schlusswort" className="article-h2">
