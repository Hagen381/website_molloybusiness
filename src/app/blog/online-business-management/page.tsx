    ...
    <>
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-4xl px-6 py-16">
          ...
          <p className="font-body mt-4 text-lg">Zumindest am Anfang.</p>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="font-body mt-4 text-lg">Und ganz ehrlich:</p>
        <p className="font-body mt-4 text-lg">
          <strong className="text-heading">
      ...
      <section className="bg-surface">
        <div className="mx-auto max-w-4xl px-6 py-16">
          ...
          <p className="font-body mt-2 text-lg">Es braucht echten Raum.</p>
          <p className="font-body mt-6 text-lg">
            <strong className="text-heading">
              3. Das Business des Kunden passt zu meiner Expertise
            </strong>
          </p>
          <p className="font-body mt-2 text-lg">Ich arbeite gerne mit:</p>
          <ul className="font-body mt-4 list-disc space-y-2 pl-6 text-lg">
            {gerneMit.map((item) => (
              <li key={item}>{item}</li>
            ))}
          </ul>
          <p className="font-body mt-4 text-lg">Nicht geeignet sind:</p>
          <ul className="font-body mt-4 list-disc space-y-2 pl-6 text-lg">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="font-body mt-4 text-lg">Und diese Klarheit verdanke ich:</p>
        <ul className="font-body mt-4 list-disc space-y-2 pl-6 text-lg">
          <li>
            <a
              href="https://schlau-digital.de/slides/ki-kurs-klarere-zielgruppe-in-unter-2-stunden-11"
